    ...
    return (
      <div id="experience" className="w-full">
        <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
          ...
          You can ask me about HTML, CSS, JS, React Native, Node.js, and some of the other development tools that I use to create my projects even though i have started learning Flutter.
          </p>
